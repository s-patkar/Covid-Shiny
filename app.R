                            ...
                            fluidRow(align = "left",       
                              column(2,offset = 2,
                                     ...
                                     selectInput("var",
                                                 ...
                                                 choices = c("Population", "Unemployment",
                                                             "Property_Rights", "Judical_Efficiency_Score",
                                                             "Life_Expectancy"),
                                                 selected = "Population"),
                                     selectInput("vary",
                              ...
                              column(6,
                                     ...
                                     h5("There seems to be a slight positive correalation between a country's population
                                     ...
                                     h5("There seems to be a strong positive and linear correlation between a country's population
